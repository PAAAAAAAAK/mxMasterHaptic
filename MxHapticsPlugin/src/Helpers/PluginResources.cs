namespace Loupedeck.MxHapticsPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MxHapticsPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MxHapticsPlugin.Resources.Resource.txt`.
