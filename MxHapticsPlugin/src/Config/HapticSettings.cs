namespace Loupedeck.MxHapticsPlugin.Config
{
    using System;
    ...
    internal sealed class HapticSettings
    {
        ...
        public void SetEnabled(String eventId, Boolean enabled)
        {
            ...
            PluginLog.Info($"[MxHaptics] {eventId} {(enabled ? "enabled" : "disabled")}.");
        }
        ...
        public void SetWaveform(String eventId, String waveform)
        {
            ...
            {
                PluginLog.Error($"[MxHaptics] Refusing unknown waveform '{waveform}'.");
                return;
            }
