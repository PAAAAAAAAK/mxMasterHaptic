namespace Loupedeck.ThrumHapticsPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ThrumHapticsPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ThrumHapticsPlugin.Resources.Resource.txt`.
