namespace Loupedeck.ThrumHapticsPlugin.SettingsUi
{
    using System;
    using System.IO;
    ...
    internal sealed class SettingsServer : IDisposable
    {
        ...
        /// </remarks>
        public static String PipeName => "ThrumHaptics.Settings." + Environment.UserName;
        ...
        public void Start()
        {
            ...
            PluginLog.Info($"[ThrumHaptics] Settings server listening on pipe '{PipeName}'.");
        }
        ...
        private async Task AcceptLoopAsync(CancellationToken token)
        {
            while (!token.IsCancellationRequested)
            {
                ...
                {
                    PluginLog.Error($"[ThrumHaptics] Settings server error: {ex.Message}");
        ...
        public void Dispose()
        {
            ...
            finally
            {
                ...
                PluginLog.Info("[ThrumHaptics] Settings server stopped.");
            }
        }
    }
}
