namespace MxHapticsSettings
{
    ...
    {
        private const String WindowTitle = "MX Haptics - Settings";
        ...
        private static void Main(String[] args)
        {
            ...
            using var singleInstance = new Mutex(true, @"Local\MxHapticsSettings", out var isFirst);
            ...
            if (client == null)
            {
                ...
                MessageBox.Show(
                    "Could not reach the MX Haptics plugin." + Environment.NewLine + Environment.NewLine
